...
set label "Beeman" at graph 0.2,0.15 center rotate by 37
set label "RKN4" at graph 0.41,0.2 center rotate by 45
plot [0.002:1][1e-7:50] "Euler0.txt" u 1:2 title "Euler" with linespoints linestyle 1, \
                  "VelocityVerlet0.txt" u 1:2 title "Velocity Verlet" with linespoints linestyle 2, \
                  "Beeman0.txt" u ($1/2):2 title "Beeman" with linespoints linestyle 3, \
                  "RK40.txt" u ($1/4):2 title "RKN4" with linespoints linestyle 4
