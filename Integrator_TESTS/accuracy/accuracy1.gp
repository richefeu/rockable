...
plot [0.002:1][1e-7:50] "Euler1.txt" u 1:2 title "Euler" with linespoints linestyle 1, \
                  "VelocityVerlet1.txt" u 1:2 title "Velocity Verlet" with linespoints linestyle 2, \
                  "Beeman1.txt" u ($1/2):2 title "Beeman" with linespoints linestyle 3, \
                  "RK41.txt" u ($1/4):2 title "RKN4" with linespoints linestyle 4
