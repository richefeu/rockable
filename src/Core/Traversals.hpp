...
#pragma omp parallel for
	...
	template<typename Func, typename I, typename... Args>
		inline
		void applyKernelTraversal(Traversal& a_traversal, Func& a_fun, std::vector<std::vector<I*>>& a_particles_interactions, Args&... a_args)
		{
#pragma omp for schedule(static)
	...
	template<typename Func, typename I, typename... Args>
		inline
		void applyKernelMutexes(Func& a_fun, std::vector<std::vector<I*>>& a_particles_interactions, Args&... a_args)
		{
...
#pragma omp parallel
	...
	template<typename Func, typename I, typename... Args>
		inline
		void applyKernel(Func& a_fun, std::vector<std::vector<I*>>& a_particles_interactions, Args&... a_args)
		{
...
#pragma omp parallel
	...
	template<typename Func, typename I, typename... Args>
		inline
		void applyKernelBlock(Func& a_fun, std::vector<std::vector<I*>>& a_particles_interactions, Args&... a_args)
		{
...
#pragma omp parallel
	...
	// accessor
	inline
		std::vector<size_t>& get_oversized_bodies_indexes(linkCells & lc)
		{
	...
	template<typename Func, typename I, typename... Args>
		inline
		void apply_kernel_oversized_bodies_only(linkCells& lc, Func& a_fun, std::vector<std::vector<I*>>& a_particles_interactions, Args&... a_args)
		{
